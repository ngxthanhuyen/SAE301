...
<head>
    ...
    <link rel="stylesheet" href="/SAE301/static/style/accueil.css">
</head>
<body>
    <!--Barre de navigation-->
    <nav class="navbar">
        ...
        <div class="navbar-right">
            ...
            <a href="?page=login_form"><img src="/SAE301/static/images/icon_user.png" alt="User Icon"></a>
        </div>
            </li>
        </div>
    ...
    <!-- Video Background -->
      <div class="video-background">
        <video autoplay muted loop id="background-video">
            <source src="/SAE301/static/images/accueil_background.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <div class="flex-list">
        <div class="feature-row">
            <div class="feature-container">
                <img src="/SAE301/static/images/home-page.png" width="150" height="150" class="card-icon">
                ...
                <div class="button-container">
                    <a href="?page=accueil" class="button">Découvrir</a>
                </div>
            </div>
            
            <div class="feature-container">
                <img src="/SAE301/static/images/stations.png" width="150" height="150" alt="Stations" class="card-icon">
                <div class="feature-content">
                ...
                <div class="button-container">
                    <a href="?page=StationsAccueil" class="button">Découvrir</a>
                </div>
            </div>

            <div class="feature-container">
                <img src="/SAE301/static/images/dashboard.png" width="150" height="120" alt="Tableau de bord" class="card-icon">
                <div class="feature-content">
                ...
                <div class="button-container">
                    <a href="?page=dashboard" class="button">Découvrir</a>
                </div>
            </div>
        </div>
        ...
        <div class="feature-row">
            <div class="feature-container">
                <img class="img-row2" src="/SAE301/static/images/climat.png" width="150" height="150" class="card-icon">
                <div class="feature-content">
                ...
                <div class="button-container">
                    <a href="?page=climatique" class="button">Découvrir</a>
                </div>
            </div>

            <div class="feature-container">
                <img class="img-row2" src="/SAE301/static/images/danger.png" width="150" height="150" alt="Stations" class="card-icon">
                <div class="feature-content">
                ...
                <div class="button-container">
                    <a href="?page=alerte" class="button">Découvrir</a>
                </div>
            </div>

            <div class="feature-container">
                <img class="img-row2" src="/SAE301/static/images/star.png" width="150" height="150" alt="Tableau de bord" class="card-icon">
                <div class="feature-content">
                ...
                <div class="button-container">
                    <a href="?page=meteotheque" class="button">Découvrir</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="/SAE301/static/js/particles.js"></script>
<script>
